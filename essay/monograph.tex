...
\usetikzlibrary{arrows.meta,positioning,shapes.geometric,calc,
                decorations.pathreplacing,cd,matrix,fit,backgrounds,patterns,calligraphy}
\usepackage{listings,xcolor,booktabs,hyperref,fancyhdr,enumitem,graphicx,subcaption}
\usepackage[backend=biber,style=ieee,sorting=none,maxbibnames=99,giveninits=true]{biblatex}
\addbibresource{references.bib}
\usepackage{cleveref,appendix,tikz-cd,wasysym,manfnt,stmaryrd,mathrsfs,bbm,dsfont}
\usepackage{algorithm,algpseudocode}   % <--- NEW
\usepackage{caption}                  % <--- NEW (for \captionof)
...
% ---------- Title ----------
\title{Polyglot Modular Computation via Sheaf Cohomology:\\A Monumental Categorical Treatise with Historical, Computational, and Epistemic Depth}
\author{Flyxion}
...
\lstset{
  ...
  tabsize=2,
  language=Haskell,               % default
  morekeywords={forall,exists,fun,let,in,match,with}
}
\lstdefinelanguage{Coq}{
  morekeywords={Definition,Theorem,Proof,Qed,Record,Inductive,CoFixpoint,
                Require,Import,Module,Section,Variable,Parameter,Let,Fixpoint,
                Match,If,Then,Else,Return,Admitted},
  sensitive=true,
  comment=[l]{(*},
  commentstyle=\color{green!60!black},
  string=[b]",
...
\tikzset{
  ...
  every matrix/.style={matrix of math nodes,nodes in empty cells,
                       column sep=2.5em,row sep=2.5em},
...
% -------------------------------------------------
%  Paste **all** the chapter/section content you already
%  have (the 80–120 pages) **exactly** here.
% -------------------------------------------------


apter{Historical Development of Categorical Modularity}
