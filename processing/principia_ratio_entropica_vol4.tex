...
\newfontfamily\ornament{Symbola}[Scale=1.1]
...
\textit{Definitio I.} \; \textit{DINGIR} (\ornament{𒀭}) dicitur signum numinis, principium lucis et ordinis.
...
\noindent \ornament{𒀭  𒂗  𒆤 \quad 𒀭  𒀸  𒋩 \quad 𒀭  𒌓  𒀭  𒊬}\\
...
\section*{Propositio I. \; Signum \ornament{𒀭} ornamentum et mensura esse potest.}

\textit{Demonstratio.} Cum \ornament{𒀭} in tabulis veteribus principium exaltatum denotet, idem hodie uti possumus ad sectiones discernendas. Ornamentum non est alienum a mensura, si transitus mentis accelerat sine ambiguitate. Ergo signum idem et decor et lex transitus est. \textit{Q.E.D.}
...
\textit{Nota.} \; \textit{Haec sectio insuper ad probationem typorum et characterum destinatur: cuneiformia (\ornament{𒀭 𒂗 𒆤 𒀭 𒌓}), numeri antiqui (ex.\ \ornament{𒑖} pro sexaginta), et figurae mixtae cum TikZ. Quae si bene imprimuntur, certiores erimus de facultatibus Lua\LaTeX{} et typorum nostrorum; si minus, emendatio in futuris codicibus diligentius parabitur.}
...
\dingir\\[0.5em]
\textit{Colophon.} \;
\textit{Volumen hoc, sub signo \ornament{𒀭}, ornamentum signorum veterum cum demonstrationibus recentioribus componit; ad usum simul doctrinalem et mechanicum scriptum est.}\\[0.25em]
